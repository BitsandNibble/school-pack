...
@if (auth('principal')->user())
    ...
    <li>
        ...
        <ul class="mm-collapse">
            ...
            <li>
                <a href="{{ route('principal.students.promote') }}"><i class="bx bx-right-arrow-alt"></i>Promote
                    Students</a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="mm-collapse">
            <li>
                <a href="{{ route('principal.result.tabulated') }}"><i class="bx bx-right-arrow-alt"></i>Tabulation
                    Sheet</a>
            </li>
            <li>
                <a href="{{ route('principal.result.marksheet') }}"><i class="bx bx-right-arrow-alt"></i>Mark
                    Sheet</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="mm-collapse">
            <li>
                <a href="{{ route('principal.settings.school') }}">
                    <i class="bx bx-right-arrow-alt"></i>
                    School
                </a>
            </li>
            <li>
                <a href="{{ route('principal.settings.comments') }}">
                    <i class="bx bx-right-arrow-alt"></i>
                    Comments Bank
                </a>
            </li>
...
@if (auth('teacher')->user())
    ...
    <li>
        ...
        <ul class="mm-collapse">
            <li>
                <a href="{{ route('teacher.result.tabulated') }}"><i class="bx bx-right-arrow-alt"></i>Tabulation
                    Sheet</a>
            </li>
            <li>
