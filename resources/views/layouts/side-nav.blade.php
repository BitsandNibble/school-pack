...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('principal.students') }}"><i class="bx bx-right-arrow-alt"></i>View
				Students</a>
		</li>
		<li>
			<a href="{{ route('principal.students.promote') }}"><i
					class="bx bx-right-arrow-alt"></i>Promote Students</a>
		</li>
		<li>
			<a href="{{ route('principal.students.manage-promotion') }}"><i
...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('create-payment') }}"><i class="bx bx-right-arrow-alt"></i>Create
				Payment</a>
		</li>
		<li>
			<a href="{{ route('manage-payment') }}"><i class="bx bx-right-arrow-alt"></i>Manage
				Payment</a>
		</li>
		<li>
			<a href="{{ route('student-payment') }}"><i class="bx bx-right-arrow-alt"></i>Student
				Payments</a>
		</li>
		<li>
			<a href="{{ route('payment.debtors') }}"><i
					class="bx bx-right-arrow-alt"></i>Debtors</a>
		</li>
	</ul>
</li>
...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('principal.classes') }}"><i
					class="bx bx-right-arrow-alt"></i>Classes</a>
		</li>
		<li>
			<a href="{{ route('principal.sections') }}"><i
					class="bx bx-right-arrow-alt"></i>Sections</a>
		</li>
	</ul>
</li>
...
<li>
	...
	<ul class="mm-collapse">
		...
		<li>
			<a href="{{ route('principal.grades') }}"><i
					class="bx bx-right-arrow-alt"></i>Grades</a>
		</li>
		<li>
			<a href="{{ route('principal.scores') }}"><i
					class="bx bx-right-arrow-alt"></i>Scores</a>
		</li>
		<li>
			<a href="{{ route('principal.skills') }}"><i
					class="bx bx-right-arrow-alt"></i>Skills</a>
		</li>
	</ul>
</li>
...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('principal.result.tabulated') }}"><i
					class="bx bx-right-arrow-alt"></i>Tabulation Sheet</a>
		</li>
		<li>
			<a href="{{ route('principal.result.marksheet') }}"><i
...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('teacher.result.tabulated') }}"><i
					class="bx bx-right-arrow-alt"></i>Tabulation Sheet</a>
		</li>
		<li>
			<a href="{{ route('teacher.result.marksheet') }}"><i
					class="bx bx-right-arrow-alt"></i>Mark Sheet</a>
		</li>
	</ul>
</li>
...
<li>
	...
	<ul class="mm-collapse">
		<li>
			<a href="{{ route('student.select-session') }}"><i
					class="bx bx-right-arrow-alt"></i>Mark Sheet</a>
		</li>
	</ul>
</li>
