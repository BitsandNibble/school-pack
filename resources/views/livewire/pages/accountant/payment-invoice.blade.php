                    ...
                    <x-slot name="body">
                        @forelse($uncleared as $index => $uc)
                            <x-table.row>
                                ...
                                <x-table.cell
                                        class="fw-bold text-decoration-underline">{{ $uc->payment->amount }}</x-table.cell>
                                <x-table.cell class="text-info">{{ $uc->amount_paid ?: '0.00' }}</x-table.cell>
                                <x-table.cell
                                        class="text-danger">{{ $uc->balance ?: $uc->payment->amount }}</x-table.cell>
                                <x-table.cell>
                                    <div class="row">
                                        <div class="col-md-7">
                                ...
                                <x-table.cell>
                                    ...
                                    <x-button-link target="_blank" href="{{ route('print_invoice', $uc->id) }}"
                                                   value="">
                    ...
                    <x-slot name="body">
                        @forelse($cleared as $cl)
                            <x-table.row>
                                ...
                                <x-table.cell
                                        class="fw-bold text-decoration-underline">{{ $cl->payment->amount }}</x-table.cell>
                                ...
                                <x-table.cell>
                                    ...
                                    <x-button-link target="_blank" href="{{ route('print_invoice', $cl->id) }}"
                                                   value="">
                                        <i class="bx bx-printer"></i>
                                    </x-button-link>
                                </x-table.cell>
