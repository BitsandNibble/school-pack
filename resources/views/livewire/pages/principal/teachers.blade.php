    ...
    <x-card>
        ...
        <x-responsive-table>
            <x-slot name="head">
                ...
                <x-table.heading sortable wire:click="sortBy('school_id')" :direction="$sorts['school_id'] ?? null">
                    Staff ID
                </x-table.heading>
                        ...
                        <x-table.cell colspan="8">
                            @unless($selectAll)
                                <div>
                                    ...
                                    @if ($teachers->count() !== $teachers->total())
            ...
            <form>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <x-input type="date" id="date_of_employment"
                                 wire:model.defer="teacher.date_of_employment"></x-input>
