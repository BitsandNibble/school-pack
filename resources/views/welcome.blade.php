            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @if(auth('principal')->user())
                        {{--                        @auth('principal')--}}
                        <a href="{{ route('principal.home') }}" class="text-sm text-gray-700 underline">Principal
                            Dashboard</a>
                    @elseif(auth('teacher')->user())
                        <a href="{{ route('teacher.home') }}" class="text-sm text-gray-700 underline">Teacher
                            Dashboard</a>
                    @elseif(auth('accountant')->user())
                        <a href="{{ route('accountant.home') }}" class="text-sm text-gray-700 underline">Accountant
                            Dashboard</a>
                    @elseif(auth('student')->user())
                        <a href="{{ route('student.home') }}" class="text-sm text-gray-700 underline">Student
                            Dashboard</a>
                    @else
                        ...
                        {{--                    @endauth--}}
                    @endif
                    <a href="components" class="ml-4 text-sm text-gray-700 underline">Components</a>
                </div>
            @endif
